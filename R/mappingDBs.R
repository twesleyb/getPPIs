...
mappingDBs <- function() {
  annotationDBs <- list(
    ...
    Bos_taurus = list(
      taxid = 9913, database = "org.Bt.eg.db", alias = "bovine"
    ),
    Caenorhabditis_elegans = list(
      ...
      taxid = 9615,
      database = "org.Cf.eg.db", alias = "dog"
    ), Drosophila_melanogaster = list(
      taxid = 7227, database = "org.Dm.eg.db", alias = "fly"
    ),
    Danio_rerio = list(
      ...
      taxid = 386585,
      database = "org.EcSakai.eg.db", alias = "ecoli-sakai"
    ),
    Gallus_gallus = list(
      ...
      taxid = 9606,
      database = "org.Hs.eg.db", alias = "human"
    ), Mus_musculus = list(
      taxid = 10090, database = "org.Mm.eg.db", alias = "mouse"
    ),
    Macaca_mulatta = list(
      ...
      taxid = 5833,
      database = "org.Pf.plasmo.db", alias = "malaria"
    ), Pan_troglodytes = list(
      taxid = 9598, database = "org.Pt.eg.db", alias = "chimp"
    ),
    Rattus_norvegicus = list(
      ...
      taxid = 4932,
      database = "org.Sc.sgd.db", alias = "yeast"
    ), Sus_scrofa = list(
      taxid = 9823, database = "org.Ss.eg.db", alias = "pig"
    ),
    Xenopus_laevis = list(
